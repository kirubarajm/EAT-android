...
public class CollectionAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private List<CollectionResponse.Result> item_list;
    private LiveProductsAdapterListener mLiveProductsAdapterListener;

    private DataManager dataManager;


    public CollectionAdapter(List<CollectionResponse.Result> item_list) {
        this.item_list = item_list;
    }

    public CollectionAdapter(List<CollectionResponse.Result> item_list, DataManager dataManager) {
        this.item_list = item_list;
    ...
    public void addItems(List<CollectionResponse.Result> blogList) {
    ...
    public interface LiveProductsAdapterListener {
        ...
        void onItemClickData(CollectionResponse.Result blogUrl);
    ...
    public class LiveProductsViewHolder extends BaseViewHolder implements CollectionItemViewModel.DishItemViewModelListener {
        ...
        public void onBind(int position) {
            ...
            final CollectionResponse.Result blog = item_list.get(position);
            mLiveProductsItemViewModel = new CollectionItemViewModel(this, blog);
