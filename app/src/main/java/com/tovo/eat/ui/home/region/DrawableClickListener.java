...
public abstract class DrawableClickListener implements View.OnTouchListener
{
     ...
     * 
     * @param view
     *            The {@link AutoCompleteTextView} that this {@link DrawableClickListener}
     *            is associated with.
     * @param drawableIndex
     ...
     */
    public DrawableClickListener(final AutoCompleteTextView view, final int drawableIndex )
    {
     ...
     *            included to account for the size of a finger.
     */
    public DrawableClickListener(final AutoCompleteTextView view, final int drawableIndex, final int fuzz )
    {
        super();
        this.fuzz = fuzz;
    ...
    public static abstract class LeftDrawableClickListener extends DrawableClickListener
    {
         ...
         * 
         * @param view
         *            The {@link AutoCompleteTextView} that this
         ...
         *            included to account for the size of a finger.
         */
        public LeftDrawableClickListener( final AutoCompleteTextView view, final int fuzz )
        {
    ...
    public static abstract class TopDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public TopDrawableClickListener( final AutoCompleteTextView view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public TopDrawableClickListener( final AutoCompleteTextView view, final int fuzz )
        {
    ...
    public static abstract class RightDrawableClickListener extends DrawableClickListener
    {
         ...
         *            included to account for the size of a finger.
         */
        public RightDrawableClickListener( final AutoCompleteTextView view, final int fuzz )
        {
    ...
    public static abstract class BottomDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public BottomDrawableClickListener( final AutoCompleteTextView view )
        {
         ...
         *            {@link BottomDrawableClickListener} is associated with.
         */
        public BottomDrawableClickListener( final AutoCompleteTextView view, final int fuzz )
        {
