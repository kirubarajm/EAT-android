        ...
        if (getDataManager().getCurrentLat() == null) {
         ...
         //   getNavigator().kitchenListLoading();
                ...
                if (!MvvmApp.getInstance().onCheckNetWork()) {
                    ...
                    try {
                        setIsLoading(true);
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, AppConstants.EAT_REGION_LIST, new JSONObject(getDataManager().getFilterSort()), new Response.Listener<JSONObject>() {
                            @Override
