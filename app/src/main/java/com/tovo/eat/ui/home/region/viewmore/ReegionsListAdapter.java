...
public class ReegionsListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ReegionsListAdapter(List<KitchenDishResponse.Productlist> item_list) {
        this.item_list = item_list;
    }


    public ReegionsListAdapter(List<KitchenDishResponse.Productlist> item_list, DataManager dataManager) {
        this.item_list = item_list;
