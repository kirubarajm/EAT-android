...
private SharedPreferences mPrefs;
    ...
    //    authenticate("aravind@tovogroup.com", "AAA123");
    ...
    private void loadPreviousStatuses() {
      //  String transportId = mPrefs.getString(getString(R.string.transport_id), "");
        FirebaseAnalytics.getInstance(this).setUserProperty("transportID", "Tovo123");
            String path = getString(R.string.firebase_path) + "Tovo123";
    ...
    private GoogleApiClient.ConnectionCallbacks mLocationRequestCallback = new GoogleApiClient
        ...
        public void onConnected(Bundle bundle) {
            ...
            mWakelock = powerManager.newWakeLock(PARTIAL_WAKE_LOCK, "MyWakelockTag");
            mWakelock.acquire();
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        mFirebaseTransportRef.addValueEventListener(new ValueEventListener() {
            ...
            //    Log.d(TAG, "Value is: " + value);
               // Toast.makeText(TrackerService.this, value, Toast.LENGTH_SHORT).show();
