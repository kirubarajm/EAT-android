...
public class FavoriteDishListItemViewModel {
    ...
    private final FavoriteDishResponse.Result dishList;
    ...
    public FavoriteDishListItemViewModel(DishItemViewModelListener mListener, FavoriteDishResponse.Result dishList) {
