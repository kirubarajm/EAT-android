...
public class StoriesPagerFragmentViewModel2 extends BaseViewModel<StoriesPagerFragmentNavigator2> {
    ...
    public StoriesPagerFragmentViewModel2(DataManager dataManager) {
        super(dataManager);
