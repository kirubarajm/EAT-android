...
public class SuggestionproductsItemViewModel {
...
DataManager dataManager;
    ...
    public SuggestionproductsItemViewModel(DishItemViewModelListener mListener, KitchenDishResponse.Productlist dishList, boolean serviceablekitchen) {
        ...
        appPreferencesHelper = new AppPreferencesHelper(MvvmApp.getInstance(), AppConstants.PREF_NAME);
    ...
    public void onItemClick() {
        ...
        //     appPreferencesHelper.getCartDetails();
