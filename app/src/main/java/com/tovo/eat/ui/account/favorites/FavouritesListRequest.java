...
public class FavouritesListRequest {
    ...
    public FavouritesListRequest(String lat, String lon, Integer makeit_userid, Integer eatuserid) {
        this.lat = lat;
        this.lon = lon;
    ...
    public FavouritesListRequest(String lat, String lon) {
        this.lat = lat;
        this.lon = lon;
    }

    public FavouritesListRequest(String lat, String lon, Integer makeit_userid) {
        this.lat = lat;
        this.lon = lon;
        this.makeit_userid = makeit_userid;
    }
