...
import com.tovo.eat.databinding.ListItemRegionKitchenBinding;
import com.tovo.eat.ui.base.BaseViewHolder;
import com.tovo.eat.ui.home.homemenu.kitchen.EmptyItemViewModel;

import java.util.List;

public class RegionKitchenAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        switch (i) {
            case VIEW_TYPE_NORMAL:
                ListItemRegionKitchenBinding blogViewBinding = ListItemRegionKitchenBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
    ...
    public class LiveProductsViewHolder extends BaseViewHolder implements RegionKitchenItemViewModel.RegionItemViewModelListener {
        ListItemRegionKitchenBinding mListItemLiveProductsBinding;
       RegionKitchenItemViewModel mLiveProductsItemViewModel;

        public LiveProductsViewHolder(ListItemRegionKitchenBinding binding) {
            super(binding.getRoot());
