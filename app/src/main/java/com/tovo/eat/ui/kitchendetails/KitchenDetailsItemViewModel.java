...
public class KitchenDetailsItemViewModel {
    ...
    public KitchenDetailsItemViewModel(DishItemViewModelListener mListener, KitchenDetailsResponse.Productlist dishList, KitchenDetailsResponse.Result response) {
